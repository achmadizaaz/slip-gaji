...
class FileService
{
     ...
     */
    public function uploadFile(object $file, string $directory, ?string $disk = 'local'): string
    {
         // Get Nama File dengan ekstensi file
     ...
     */
    public function downloadFile(string $filePath, ?string $disk = 'local', string $customName = null)
    {
